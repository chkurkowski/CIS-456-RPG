...
public class Room {
    ...
    //Constructor
    public Room(Vector2 c, Vector2 s, string t)
    {
        checkValidSize(s);
    ...
    public Room(Vector2 c, string t)
    {
        center = c;
        size = OnexOne;
        type = t;
    ...
    public List<Room> getUniqueNeighboringRooms()
    {
        List<Room> roomList = new List<Room>();
        ...
        return roomList.Distinct().ToList();
    }

    public Vector3 getRandomPosition(int wallOffset = 2)
    {
